import {
  ...
  @Component({
    ...
    templateUrl: './download-csv-page.component.html',
    styleUrls: ['./download-csv-page.component.scss'],
    encapsulation: ViewEncapsulation.Emulated,
  })
  export class DownloadCSVPageComponent implements OnInit, OnDestroy {
